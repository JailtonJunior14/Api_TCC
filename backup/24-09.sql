...
CREATE TABLE `contratante` (
  ...
  `infoadd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `telefone` VALUES (1,1,'(81) 9874-3554'),(2,2,'(81) 5698-3554'),(6,6,'(81) 5678-4381'),(7,7,'(81) 1835-1199'),(8,8,'(21) 24355-4656'),(9,9,'(14) 98133-7566'),(10,10,'(47) 2825-4483'),(11,11,'(65) 65666-8888'),(12,12,'(14) 55387-9642');
...
CREATE TABLE `users` (
  ...
  `type` enum('empresa','prestador','contratante') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-09-24 15:19:10
